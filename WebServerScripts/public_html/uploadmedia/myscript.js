var fileTypes = ['jpg', 'jpeg', 'png', 'mp4', 'mkv'];  //acceptable file types
    ...
    if (input.files && input.files[0]) {
        ...
        if (isSuccess) { //yes
            ...
            reader.onload = function (e) {
                if (extension == 'png'){ $(input).closest('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/svg/136/136523.svg'); 
                }
